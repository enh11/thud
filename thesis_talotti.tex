...
\end{align*}
By the formulas above we find that $n_B=24.10$ and $c_B=13.05$. This means that there are approximately $2^{24}=16777216$ weak keys lying in subgroups of order below the bound $B$.
