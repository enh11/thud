...
\chapter{Elliptic curves arithmetic over finite fields}\label{ellfinfilar}
...
for a doubling. The parameter $a_4 = 0$ is even more advantageous as the costs drop down to 3$\mathcal{M}$ + 4$\mathcal{S}$. This justifies
 the curve's parameter for $a_4$ used in standardized curves presented in Section \ref{NISTcurves}. On my repository \cite{repo} you can find and implementation  written in Rust of these formul\ae\ and the Montgomery ladder algorithm for scalar multiplication.
